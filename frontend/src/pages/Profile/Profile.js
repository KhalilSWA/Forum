...
import { myPosts,deletePost, updatePost } from '../../redux/postSlice';
          ...
          {posts.length > 0 ? posts.map((post =>
            ...
            <Card style={{ width: '18rem', float: 'left', margin: '20px 20px' }} key={post._id}>
              ...
              <Card.Body>
                ...
                <ListGroup.Item>
                  <Button variant="secondary" style={{ width: '40px',height:'40px', margin: '5px 15px',marginLeft:'40px',marginTop:'10px' }}
